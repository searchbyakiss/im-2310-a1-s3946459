...
// I want to check if the user has a preference for dark mode - if they do we'll set the page to dark mode by default
// we can do this by using the matchMedia function - this checks if the user's browser has a preference for dark mode
